module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        clean: {
            dev: {
                src: ["src/css/*", "src/js/app/scripts.js", "!src/css/bootstrap.min.css", "!src/css/bootstrap.min.css.map", "!src/css/fontawesome.min.css", "!src/css/solid.min.css", "!src/css/webfonts"]
            },
            prod: {
                src: ["build/**"]
            }
        ...
        copy: {
            prod: {
                expand: true,
                cwd: 'src',
                src: ["index.html", "css/bootstrap.min.css", "css/bootstrap.min.css.map", "css/fontawesome.min.css", "css/solid.min.css", "css/webfonts/**", "js/lib/**", "videos/filmik.mp4"],
                dest: 'build/',
            }
        },
        replace: {
